...
Seguro.prototype.cotizarSeguro = function () {
  /*
        ...
        3 = Europeo incrementa el valor en 1.35
    */
  let cantidad;
  const base = 2000;
   ...
   * va a reducirse un 3% el valor del seguro
   */
...
UI.prototype.mostrarMensaje = (mensaje, tipo) => {
  // Si hay un mensaje, se elimina para mostrar el nuevo mensaje
  const currentDiv = document.querySelector(".mensaje");
